package com.jspider.builderdesignpattern.builder;
...
public class MobileBuilder {
	...
	public MobileBuilder bettery (int bettery) {
	...
	public Mobile getMobile() {
		Mobile mobile = new Mobile(this.brand, this.model, 
									this.ram, this.memory, 
									this.front_cam, this.rear_cam, 
									this.price, this.bettery, 
